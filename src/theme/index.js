export default {
  ...
  colors: {
    ...
    heading_secondary: '#1338be', // heading color
    background: '#fff', // body background color
    background_secondary: '#f9d71c', // secondary background color
    border_color: '#E5ECF4', // border color
    yellow: '#f9d71c', // border color
    primary: '#1338be', // primary button and link color
    secondary: '#f9d71c', // secondary color - can be used for hover states
  ...
  buttons: {
    ...
    primary: {
      ...
      bg: 'primary',
      '&:hover': {
        boxShadow: 'rgba(19, 56, 190, 0.57) 0px 9px 20px -5px',
      },
    },
    whiteButton: {
      variant: 'buttons.defaultBtn',
